...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='servicecluster',
            name='service_type',
            field=models.ForeignKey(help_text='The Ansible service type of this service cluster.', on_delete=django.db.models.deletion.CASCADE, related_name='clusters', to='aap_gateway_api.servicetype', null=True),
        ),
        ...
        migrations.AlterField(
            model_name='servicecluster',
            name='service_type',
            field=models.ForeignKey(help_text='The Ansible service type of this service cluster.', on_delete=django.db.models.deletion.CASCADE, related_name='clusters', to='aap_gateway_api.servicetype', null=False),
        ),
    ]
