...
def setup():
    ...
    team_content_type = ContentType.objects.get_for_model(Team, for_concrete_model=False)
    for access_level in access_levels:
        role_definition_name = f'{resource_type} {access_level}'
        role_definition = RoleDefinition.objects.create(name=role_definition_name, managed=True, content_type=team_content_type)
    ...
    org_content_type = ContentType.objects.get_for_model(other_org)
