# Gateway DRF Integration

If you are using the Django Rest Framework for your API you can use this library as a simple way to integrate your application with Gateway's authentication mechanism.
