...
As of the 2.6 version, the following fields in the User API are deprecated and will be removed in a future version:
...
AAP Gateway development environment comes with a RADIUS sidecar container,
